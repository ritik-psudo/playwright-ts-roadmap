...
- Name: day_32\day_32_practice.spec.ts >> another trace practice
- Location: tests\day_32\day_32_practice.spec.ts:9:1
...
Call log:
  - waiting for locator('#non-exisiting-button')
        ...
        - generic [ref=e43]:
          ...
          - generic [ref=e45]:
            - link "Star microsoft/playwright on GitHub" [ref=e46] [cursor=pointer]:
              - /url: https://github.com/microsoft/playwright
              - text: Star
            - link "93k+ stargazers on GitHub" [ref=e48] [cursor=pointer]:
    ...
    - generic [ref=e164]:
      - generic [ref=e165]:
          ...
          - list [ref=e168]:
            - listitem [ref=e169]:
              - link "Getting started" [ref=e170] [cursor=pointer]:
                - /url: /docs/intro
            - listitem [ref=e171]:
              - link "Playwright Training(opens in new tab)" [ref=e172] [cursor=pointer]:
        ...
        - generic [ref=e179]:
          ...
          - list [ref=e181]:
            - listitem [ref=e182]:
              - link "Stack Overflow(opens in new tab)" [ref=e183] [cursor=pointer]:
                - /url: https://stackoverflow.com/questions/tagged/playwright
                - text: Stack Overflow
                - img "(opens in new tab)" [ref=e184]
            - listitem [ref=e186]:
              - link "Discord(opens in new tab)" [ref=e187] [cursor=pointer]:
                - /url: https://aka.ms/playwright/discord
                - text: Discord
                - img "(opens in new tab)" [ref=e188]
            - listitem [ref=e190]:
              - link "X(opens in new tab)" [ref=e191] [cursor=pointer]:
                - /url: https://x.com/playwrightweb
                - text: X
                - img "(opens in new tab)" [ref=e192]
            - listitem [ref=e194]:
              - link "LinkedIn(opens in new tab)" [ref=e195] [cursor=pointer]:
                - /url: https://www.linkedin.com/company/playwrightweb
                - text: LinkedIn
                - img "(opens in new tab)" [ref=e196]
        - generic [ref=e198]:
          - generic [ref=e199]: More
          - list [ref=e200]:
            - listitem [ref=e201]:
              - link "GitHub(opens in new tab)" [ref=e202] [cursor=pointer]:
                - /url: https://github.com/microsoft/playwright
                - text: GitHub
                - img "(opens in new tab)" [ref=e203]
            - listitem [ref=e205]:
              - link "YouTube(opens in new tab)" [ref=e206] [cursor=pointer]:
                - /url: https://www.youtube.com/channel/UC46Zj8pDH5tDosqm1gd7WTg
                - text: YouTube
                - img "(opens in new tab)" [ref=e207]
            - listitem [ref=e209]:
              - link "Blog(opens in new tab)" [ref=e210] [cursor=pointer]:
                - /url: https://dev.to/playwright
                - text: Blog
                - img "(opens in new tab)" [ref=e211]
            - listitem [ref=e213]:
              - link "Ambassadors" [ref=e214] [cursor=pointer]:
                - /url: /community/ambassadors
            - listitem [ref=e215]:
              - link "Microsoft Privacy Statement(opens in new tab)" [ref=e216] [cursor=pointer]:
                - /url: https://go.microsoft.com/fwlink/?LinkId=521839
                - text: Microsoft Privacy Statement
                - img "(opens in new tab)" [ref=e217]
...
```ts
  ...
  2  | 
  3  | test("failed test for trace", async ({ page }) => {
  4  |   await page.goto("https://playwright.dev/");
  5  |   //await expect(page).toHaveTitle(/NonExistingTitle/); //failing intentionally
  6  |   await expect(page).toHaveTitle(/Playwright/);
  7  | });
  8  | 
  9  | test("another trace practice", async ({ page }) => {
  10 |   await page.goto("https://playwright.dev/");
> 11 |   await page.click("#non-exisiting-button"); //this locator doesn't exist
     |              ^ Error: page.click: Test timeout of 30000ms exceeded.
